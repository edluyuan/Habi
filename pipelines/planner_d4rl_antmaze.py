...
def pipeline(args):
    ...
    if args.enable_wandb and args.mode=="inference":
        wandb.require("core")
        wandb.init(
            reinit=True,
            id=str(uuid.uuid4()),
    ...
    save_path = f'{args.save_dir}/{args.pipeline_name}/{args.task.env_name}/'
    video_path = f'video_outputs/{args.pipeline_name}/{args.task.env_name}/'
