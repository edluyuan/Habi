...
@hydra.main(config_path="../configs/habi/mujoco", config_name="mujoco", version_base=None)
def pipeline(args):
    ...
    dql_base_path = f'dql_d4rl_mujoco'
    ...
    # td_dataset
    planner_td_dataset = D4RLMuJoCoTDDataset(d4rl.qlearning_dataset(env), state_normalizer=state_normalizer)
